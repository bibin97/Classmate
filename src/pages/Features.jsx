        ...
        <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="bg-gray-50 p-4 rounded-xl border border-gray-100 transition-all cursor-default"
                                >
            ...
            <section className="section-padding bg-brand-primary relative">
                <div className="container text-center">
                    ...
                    <p className="text-lg text-gray-600 mb-16 max-w-2xl mx-auto">We don't just teach chapters. We identify and fix the root causes of academic struggle.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                        ...
                        {steps.map((step, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 relative z-10 group hover:border-brand-teal transition-colors"
                            >
                ...
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                            viewport={{ once: true }}
                            className="bg-gray-50 p-8 md:p-10 rounded-[2.5rem] border border-gray-100"
                        >
            ...
            <section className="section-padding bg-brand-primary">
                <div className="container">
                    <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center">What’s Included in <span className="text-brand-teal">Classmate?</span></h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {outcomes.map((item, index) => (
                            <motion.div
                                key={index}
                                whileHover={{ y: -5 }}
                                className="bg-gray-50 p-6 rounded-2xl text-center border border-gray-100 hover:border-brand-teal transition-all"
                            >
            ...
            <section className="py-20 container">
                <motion.div
                    ...
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    className="bg-white rounded-[2.5rem] p-12 text-center border border-gray-100 shadow-lg relative overflow-hidden"
                >
